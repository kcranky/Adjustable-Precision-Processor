...
HD_PWD='S:/Uni/EEE4022S/Code/FPGAProjectTesting/MathematicOperations/MathematicOperations.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log implementation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source implementation.tcl
