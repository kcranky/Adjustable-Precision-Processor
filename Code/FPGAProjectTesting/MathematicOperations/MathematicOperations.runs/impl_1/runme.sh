...
HD_PWD='S:/Uni/EEE4022S/Code/FPGAProjectTesting/MathematicOperations/MathematicOperations.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log implementation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source implementation.tcl -notrace
